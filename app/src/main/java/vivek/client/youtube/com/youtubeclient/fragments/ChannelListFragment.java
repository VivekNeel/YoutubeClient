...
public class ChannelListFragment extends Fragment implements INetworkCallback {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        LinearLayoutManager linearLayoutManager = (LinearLayoutManager) channelRV.getLayoutManager();
        channelRV.addItemDecoration(new DividerItemDecoration(getActivity(), linearLayoutManager.getOrientation()));
