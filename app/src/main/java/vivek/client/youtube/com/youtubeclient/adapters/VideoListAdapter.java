...
public class VideoListAdapter extends RecyclerView.Adapter<VideoListAdapter.VideoListViewHolder> {
    ...
    public VideoListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_playlist_video_new, parent, false);
    ...
    private void setupPlaylistVideos(int position, VideoListViewHolder holder) {
        ...
        String imageUrl = snippet.getThumbnails().getMedium().getUrl();
        ...
        Picasso.with(context).load(imageUrl).into(holder.videoThumbnail);
